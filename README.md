...
📁 runbooks           # Operational runbooks and their scripts (version-check, health-check)
📁 tools              # Utility scripts and one-off automation helpers
📁 docs
├── 📁 troubleshooting # Active investigations — deleted when resolved
├── version-check-current.md   # Auto-generated by runbooks/check-all-versions.py
└── health-check-current.md    # Latest weekly health check output
```
