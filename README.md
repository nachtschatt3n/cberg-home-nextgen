...
- **Operating System**: [Talos Linux v1.13.7](https://www.talos.dev/) provides immutable infrastructure and secure-by-default configuration (kernel 6.18.39, Clang/ThinLTO build)
