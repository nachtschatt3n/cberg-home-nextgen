...
1. Log in to Authentik at `https://auth.uhl.cool`
...
4. Configure the provider:
   ...
   - **Redirect URIs**: `https://pgadmin.uhl.cool/oauth2/callback`
...
3. Configure the application:
   ...
   - **Launch URL**: `https://pgadmin.uhl.cool`
4. Click **Create**
...
1. Navigate to `https://pgadmin.uhl.cool`
