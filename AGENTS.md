...
```
docs/
  runbooks/                    # Recurring operational procedures (living docs)
  ...
  version-check-current.md     # Auto-generated by check-all-versions.py (do not hand-edit)
...
| Situation | Where |
|-----------|-------|
| Recurring task that needs a procedure | `docs/runbooks/<name>.md` |
