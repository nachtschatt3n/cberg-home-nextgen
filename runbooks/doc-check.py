...
def main(argv: list[str] | None = None) -> int:
    ...
    auto-close step resolves every open doc finding this run never re-examined.
    Return 3 on purpose -- outside the "completed" set.
    """
    ...
    try:
        ...
        try:
            ...
            print(f"CRITICAL: the crash veto could not be recorded "
                  f"({type(veto_exc).__name__}: {veto_exc}) — open doc "
