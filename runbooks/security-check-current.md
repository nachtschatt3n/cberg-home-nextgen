# Security Audit — 2026-02-28 23:34 UTC

> Auto-generated by security-check.py — do not hand-edit. Sensitive values redacted as [DOMAIN], [NAME], [EMAIL].
...
- 🟡 Possible inline credential: `kubernetes/apps/default/homepage/app/ingress.yaml:      proxy_set_header X-Proxy-Secret 56915e032a849697664f1ee8567e8ffe`
- 🟡 Possible inline credential: `kubernetes/apps/home-automation/esphome/app/ingress.yaml:      proxy_set_header X-Proxy-Secret 256bc2442db37f82cc474c85d`
- 🟡 Possible inline credential: `kubernetes/apps/home-automation/frigate-nvr/app/ingress.yaml:      proxy_set_header X-Proxy-Secret a12644bc9bebd49f58f48`
- 🟡 Possible inline credential: `kubernetes/apps/monitoring/kube-prometheus-stack/app/prometheus-ingress.yaml:      proxy_set_header X-Proxy-Secret 9f816`
- 🟡 Possible inline credential: `kubernetes/apps/monitoring/kube-prometheus-stack/app/alertmanager-ingress.yaml:      proxy_set_header X-Proxy-Secret 5fe`
- 🟡 Possible inline credential: `kubernetes/apps/monitoring/unpoller/app/helmrelease.yaml:      auth_token = "Mmih1SVbxAJMQY36zknZN-p09CRDZbtDNzS2wO22o7N`
- 🟡 Possible inline credential: `kubernetes/apps/office/nextcloud/app/whiteboard-proxy.yaml:          value: "a68fdf7688d44d432ca8c2b5e6fc1fdbef2427dffe9`
- 🟡 Possible inline credential: `kubernetes/apps/storage/longhorn/app/ingress.yaml:      proxy_set_header X-Proxy-Secret 56915e032a849697664f1ee8567e8ffe`
- 🟡 Possible inline credential: `kubernetes/bootstrap/talos/clusterconfig/kubernetes-k8s-nuc14-01.yaml:    crt: LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCk1JS`
- 🟡 Possible inline credential: `kubernetes/bootstrap/talos/clusterconfig/kubernetes-k8s-nuc14-01.yaml:    key: LS0tLS1CRUdJTiBFRDI1NTE5IFBSSVZBVEUgS0VZL`
...
- 🟡 Credential-like pattern in history: `-  password: clickhouse123`
- 🟡 Credential-like pattern in history: `-  POSTGRES_PASSWORD: langfuse123`
- 🟡 Credential-like pattern in history: `+| `kubernetes/apps/ai/langfuse/app/clickhouse.yaml` | 🔴 **Plaintext** `password: clickhouse123` in `
- 🟡 Credential-like pattern in history: `+| `kubernetes/apps/ai/langfuse/app/postgresql.yaml` | 🔴 **Plaintext** `POSTGRES_PASSWORD: langfuse1`
- 🟡 Credential-like pattern in history: `+        secret = ref.get('name', '(none)') if ref else '(none)'`
- 🟡 Secret-named file committed outside sops: `kubernetes/apps/ai/bytebot/app/secret.sops.tmp.yaml`
- 🟡 Secret-named file committed outside sops: `kubernetes/apps/ai/langfuse/app/s3-credentials.yaml`
- 🟡 Secret-named file committed outside sops: `kubernetes/apps/backup/kopia/app/secret.yaml`
- 🟡 Secret-named file committed outside sops: `kubernetes/apps/databases/pgadmin/app/secret.sops.yaml.bak`
- 🟡 Secret-named file committed outside sops: `kubernetes/apps/databases/pgadmin/app/secret.yaml`
- 🟡 Secret-named file committed outside sops: `kubernetes/apps/download/icloud-docker/app-secrets/kustomization.yaml`
- 🟡 Secret-named file committed outside sops: `kubernetes/apps/download/icloud-docker/secrets-ks.yaml`
- 🟡 Secret-named file committed outside sops: `kubernetes/apps/monitoring/headlamp/app/token-secret.yaml`
- 🟡 Secret-named file committed outside sops: `kubernetes/apps/monitoring/rybbit/app/secret.sops.tmp.yaml`
- 🟡 Secret-named file committed outside sops: `kubernetes/apps/monitoring/rybbit/clickhouse/secret.yaml`
- 🟡 Secret-named file committed outside sops: `kubernetes/flux/meta/repositories/git/github-k8s-self-ai-ops-secret-temp.yaml`
- 🟡 Secret-named file committed outside sops: `kubernetes/flux/meta/repositories/helm/external-secrets.yaml`
- 🟡 Secret-named file committed outside sops: `templates/config/kubernetes/apps/cert-manager/cert-manager/issuers/secret.sops.yaml.j2`
- 🟡 Secret-named file committed outside sops: `templates/config/kubernetes/apps/flux-system/flux-operator/instance/github/webhooks/secret.sops.yaml.j2`
- 🟡 Secret-named file committed outside sops: `templates/config/kubernetes/apps/network/external/cloudflared/secret.sops.yaml.j2`
- 🟡 Secret-named file committed outside sops: `templates/config/kubernetes/apps/network/external/external-dns/secret.sops.yaml.j2`
- 🟡 Secret-named file committed outside sops: `templates/config/kubernetes/flux/components/common/cluster-secrets.sops.yaml.j2`
...
- 🟡 Privileged: `home-automation/frigate-86f45bb8f6-krnnl` (frigate)
- 🟡 Privileged: `home-automation/otbr-59c669f9c4-d7p5g` (app)
- 🟡 Privileged: `home-automation/scrypted-7d77d7649d-wspx9` (app)
- 🟡 Privileged: `media/jellyfin-7b86c7c64f-2lm96` (jellyfin)
- 🟡 Privileged: `media/makemkv-7dcb467b64-vbthp` (main)
- 🟡 Root uid=0: `ai/openclaw-7df986975-xckgp` (install-openclaw)
- 🟡 Root uid=0: `backup/icloud-docker-mu-db549c5b-v5ncv` (app)
- 🟡 Root uid=0: `home-automation/node-red-695d77c979-5vxxx` (app)
- 🟡 Root uid=0: `home-automation/scrypted-7d77d7649d-wspx9` (app)
- 🟡 Root uid=0: `media/jellyfin-7b86c7c64f-2lm96` (jellyfin)
- 🟡 Root uid=0: `media/makemkv-7dcb467b64-vbthp` (main)
...
- 🟢 `sops-age` secret present in flux-system

- 🟢 Receiver `github-receiver`: secretRef=`github-webhook-token-secret`

- 🟢 `flux-system/flux-system`: no inline credentials

- 🟢 `flux-system/k8s-self-ai-ops`: no inline credentials

- 🟡 flux-operator has cluster-admin (standard but broad)
...
|---------|--------|----------|
| 1. SOPS Encryption Coverage | 🟡 | 10 warning |
| 2. Sensitive Data Exposure | 🟢 | clean |
| 3. Git History Secret Scan | 🟡 | 22 warning |
| 4. CVE / Vulnerability Check | 🟢 | clean |
| 5. Authentik Login Analysis | 🟢 | clean |
| 6. External Attack Patterns | 🟢 | clean |
| 7. RBAC & Pod Security | 🟡 | 11 warning |
| 8. External Exposure Inventory | 🟢 | clean |
| 9. Certificate Integrity | 🟡 | 1 warning |
| 10. Flux Security Posture | 🟡 | 1 warning |
| 11. UniFi Network Security | 🟢 | clean |
...
- **Git History Secret Scan**: Credential-like pattern in history: `-  password: clickhouse123`
- **Git History Secret Scan**: Credential-like pattern in history: `-  POSTGRES_PASSWORD: langfuse123`
- **Git History Secret Scan**: Credential-like pattern in history: `+| `kubernetes/apps/ai/langfuse/app/clickhouse.yaml` | 🔴 **Plaintext** `password: clickhouse123` in `
- **Git History Secret Scan**: Credential-like pattern in history: `+| `kubernetes/apps/ai/langfuse/app/postgresql.yaml` | 🔴 **Plaintext** `POSTGRES_PASSWORD: langfuse1`
- **Git History Secret Scan**: Credential-like pattern in history: `+        secret = ref.get('name', '(none)') if ref else '(none)'`
