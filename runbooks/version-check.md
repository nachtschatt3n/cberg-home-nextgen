...
Full contract — statuses, the incomplete-run veto (and its per-component
scoped form: a single rate-limited registry no longer suppresses the whole
section), and why a PASS
